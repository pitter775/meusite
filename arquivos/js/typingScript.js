class TypeWriter {
    ...
    type() {
        ...
        const typingElement = document.querySelector('.animarfas');
        ...
        if(this.isDeleting){
            typingElement.className = "fas fa-pencil-alt erasing-animation animarfas";
        }else{
            typingElement.className = "fas fa-pencil-alt writing-animation animarfas";
        }
        ...
        if(!this.isDeleting && this.txt === fullTxt){
            ...
            typingElement.className = "fas fa-pencil-alt animarfas";
...
const words = ['Programador','Designer', 'User Interface', 'PHP', 'Laravel', 'MySQL', 'Vuejs', 'Javascript','Photoshop'];
